...
//--------------------------------------------------------
// AD7747 Register Data Definition for Differential Input Configuration +- 8.192pF as the Figure 30. from datasheet.
// For AD7745 and AD7746 you must use your registry settings! For AD7745/46 also edit one marked row in the AD774X_Sampling section.
...
const uint8_t EEPROMStart    = 0;          // first address of EEPROM
...
unsigned long OldTime = 0;                 // for time counter
