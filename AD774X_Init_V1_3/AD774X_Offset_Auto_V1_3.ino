  ...
  if ((AD774X_Read_Single_Register(ADR_STATUS) & CAP_RDY) == 0) {
    ...
    if (StepByStep < 4 * HowManySteps) {
      ...
      if (StepByStep >= 4 * HowManySteps) {
        ...
        if (C2 >= 0) FineOffset = 32768.0 - FineOffset;
